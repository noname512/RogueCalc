    ...
    <div class="background" >
        <div class="transparent-panel" id="panel">
            ...
            <a href="https://tomimi.cyou/zh/sami">
                <img style="position: absolute; left: 40px; top: 900px;" src="./assets/images/tomimi.png" alt="tomimi">
                <div class="central-text" style="left: 105px; top: 1035px;">TOMIMI</div>
            </a>
            <a href="https://viktorlab.cn/akdata/dps/">
                <img style="position: absolute; left: 220px; top: 900px;" src="./assets/images/dpscalc.png" alt="dpscalc">
                <div class="central-text" style="left: 285px; top: 1035px;">DPS计算器</div>
            </a>
            <a href="https://mapcn.ark-nights.com/areas/rogue_3">
                <img style="position: absolute; left: 400px; top: 900px;" src="./assets/images/prtsmap.png" alt="tomimi">
...
export default {
    ...
    data() {
        return {
            ...
            bossSrc: [
                require("./assets/images/b-7-b.png"),
                require("./assets/images/b-6-b.png"),
                require("./assets/images/b-5-b.png"),
                require("./assets/images/b-4-b.png"),
                require("./assets/images/b-7.png"),
                require("./assets/images/b-6.png"),
                require("./assets/images/b-5.png"),
                require("./assets/images/r-1.png"),
                require("./assets/images/r-2.png"),
                require("./assets/images/r-3.png"),
                require("./assets/images/r-4.png"),
                require("./assets/images/r-5.png")
            ],
            battleText: [
                "关卡类型",
                "关卡层数",
...
@font-face {
    ...
    src: url('./assets/font/Novecento WideMedium.otf');
}

@font-face {
    font-family: '标小智无界黑';
    src: url('./assets/font/标小智无界黑.TTF');
}
...
.background {
    background-image: url('./assets/images/pure-background.jpg');
